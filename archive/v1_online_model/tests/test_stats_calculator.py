...
# ---------------- alltime breakdown (2026-07-08) ----------------
# a "session" block scoped to state.json's session_start_ts briefly lived
# here too, but was removed the same day: dashboard_pro.html never read it
# (its own client-side scopeTradesToSession() is the single source of truth
# for the Portfolio panel's session view), so it was a second, unused
# implementation of the same scoping logic.
